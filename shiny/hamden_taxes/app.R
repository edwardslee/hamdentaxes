...
ui <- fluidPage(
  ...
  tags$div(
    id = "above-tabs-text",
    h2("Hamden Tax Calculator (updated on 6/6/2025)"),
    p("This app helps you estimate your property taxes for 2025-2026 (FY2026).
    The calculator will estimate taxes based on different scenarios regarding the budget and the reevaluation phase-in approved by the Legislative Council.
    ...
    tabPanel(
      ...
      fluidRow(
        column(12, class = "top-section",
               h3("2025-2026 (FY26) Property Tax Calculator (updated on 6/6/2026)"),
               p("Estimate your property taxes for the upcoming year (FY2026) based on three scenarios:"),
               tags$li("Property taxes with the budget that includes the use of a one-time $17.7 million surplus and with ", strong("a 4-year phase-in "), "of the reevaluation. The mill rate in this situation is estimated to be 52.16 by the LC."),
               tags$li("Property taxes with the budget that includes the use of a one-time $17.7 million surplus and  with ", strong("no phase-in"), "The mill rate in this situation is estimated to be about 39.00."),
               tags$li("Property taxes with the budget ", strong("without"), " the one-time $17.7 million surplus and no phase-in (i.e., the original proposed budget with a mill rate of 43.39)."),
               br(),
               p("To use the calculator:"), 
               tags$li("On the left, search for an address and then choose one from the dropdown menu"),
               tags$li("You are able to adjust the mill rates for all three situations as well.")
        )
      ),
      ...
      sidebarLayout(
        ...
        sidebarPanel(
          ...
          # Add mill rate input
          numericInput("mill_rate_tab1", "Enter mill rate for phase-in with the surplus:", 
                       value = 52.16, min = 15, max = 100, step = 0.01),
          helpText("The estimated mill rate with the 4-year phase-in with surplus is 52.16"),
          numericInput("mill_rate_nophase", "Enter mill rate for no phase-in with the surplus:", 
                       value = 39.00, min = 15, max = 100, step = 0.01),
          helpText("The estimated mill rate with no phase-in with the surplus is 39.00"),
          numericInput("mill_rate_original", "Enter mill rate for no phase-in with no surplus:", 
                       value = 43.39, min = 15, max = 100, step = 0.01),
          helpText("The estimated mill rate with the original budget (no surplus) is 43.39")#,
        ),
  ...
  output$string_tab1 <- renderText({
    ...
    if (prop_tax_diff_phasein > 0) {
      string <- str_c("In 2024-2025 (FY2025), your property taxes were $",
                      ...
                      "<b>With the surplus and 4-year phase-in:</b>", " your property taxes in 2025-2026 (FY2026) are estimated to be <b>$",
                      prop_tax_new_phasein, "</b>. Your property taxes would increase by $", prop_tax_diff_phasein,
                      ", which is a ", prop_perc_inc_phasein, "% increase, and you would pay an extra $",
                      monthly_payment_phasein," per month in taxes. <br/><br/>",
                      
                      # surplus + no phase in 
                      "<b>With the surplus and no phase-in:</b>", " your property taxes in 2025-2026 (FY2026) are estimated to be <b>$",
                      prop_tax_new_nophase, "</b>. Your property taxes would increase by $", prop_tax_diff_nophase,
                      ", which is a ", prop_perc_inc_nophase, "% increase, and you would pay an extra $",
                      monthly_payment_nophase, " per month in taxes. <br/><br/>",
                      
                      # original
                      "<b>With original budget with no surplus:</b>", " your property taxes in 2025-2026 (FY2026) are estimated to be <b>$",
                      prop_tax_new_original, "</b>. Your property taxes would increase by $", prop_tax_diff_original,
                      ", which is a ", prop_perc_inc_original, "% increase, and you would pay an extra $",
                      monthly_payment_original, " per month in taxes. <br/><br/>"
      )
    } else {
      ...
      string <- str_c("In 2024, your property taxes were $",
                      prop_tax_old,
                      ", and your home had a valuation of $",
                      appraisal_old, ".<br/><br/>",
                      strong("With the 4-year phase-in:"), " your property taxes are estimated to be <b>$",
                      prop_tax_new_phasein, ". Your property taxes will decrease by $", prop_tax_diff_phasein,
                      ", which is a ", prop_perc_inc_phasein, "% decrease, and you will pay an extra $",
                      monthly_payment_phasein," per month in taxes. <br/><br/>",
                      strong("Without the phase-in:"), " your property taxes would have been estimated to be <b>$",
                      prop_tax_new_nophase, ". Your property taxes would have increased by $", prop_tax_diff_nophase,
                      ", which is a ", prop_perc_inc_nophase, "% increase, and you would have paid an extra $",
                      monthly_payment_nophase, " per month in taxes."
      )
    }
    string
  })
